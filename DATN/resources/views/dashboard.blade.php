 ...
 @section('content')
    ...
    <div class="tp-slider-active tp-slider-variation swiper-container" data-loop="" data-autoplay="1"
     ...
     <script data-pagespeed-no-defer="1" src={{ asset('client/themes/shofy/js/jquery-3.7.1.min.js') }}></script>
     ...
     <script defer src={{ asset('client/vendor/core/plugins/ecommerce/libraries/slick/slick.min.js') }}></script>
