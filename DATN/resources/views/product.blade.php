 ...
 @section('content')
     <main>
         <section class="breadcrumb__area include-bg pt-60 pb-60 mb-50 mb-30 text-start pt-30 page_speed_1957708400">
             <div class="container">
                         ...
                         <div class="tp-brand-slider-active swiper-container">
                             <div class="swiper-wrapper">
                                 <div class="tp-brand-item swiper-slide text-center">
                                     <a href="brands/foodpound.html"><img src=storage/main/general/placeholder.png
                                             data-bb-lazy="true" loading="lazy" class="page_speed_2122084107"
                                             data-src="https://shofy.botble.com/storage/main/brands/1.png"
                                             alt="FoodPound"></a>
                                 </div>
                                 <div class="tp-brand-item swiper-slide text-center">
                                     <a href="brands/itea-jsc.html"><img src=storage/main/general/placeholder.png
                                             data-bb-lazy="true" loading="lazy" class="page_speed_2122084107"
                                             data-src="https://shofy.botble.com/storage/main/brands/2.png"
                                             alt="iTea JSC"></a>
                                 </div>
                                 <div class="tp-brand-item swiper-slide text-center">
                                     <a href="brands/soda-brand.html"><img src=storage/main/general/placeholder.png
                                             data-bb-lazy="true" loading="lazy" class="page_speed_2122084107"
                                             data-src="https://shofy.botble.com/storage/main/brands/3.png"
                                             alt="Soda Brand"></a>
                                 </div>
                                 <div class="tp-brand-item swiper-slide text-center">
                                     <a href="brands/shofy.html"><img src=storage/main/general/placeholder.png
                                             data-bb-lazy="true" loading="lazy" class="page_speed_2122084107"
                             ...
                             <div class="tp-product-category-item text-center mb-40">
                                 <div class="tp-product-category-thumb fix">
                                     <a href="product-categories/computers-laptops.html"
                                         title="Computers &amp; Laptops"><img src=storage/main/general/placeholder.png
                                     ...
                                     <form action="https://shofy.botble.com/products"
                                         ...
                                         <div class="bb-ecommerce-filter-hidden-fields">
                                             <input name=layout type=hidden class="product-filter-item"
                                                 ...
                                                 value="2"><input name=per-page type=hidden
                                                             ...
                                                             <li class="bb-product-filter-item">
                                                                 ...
                                                                 <button
                                                                     data-bb-toggle="toggle-product-categories-tree"><svg
                                                                         ...
                                                                         stroke="currentColor" stroke-width="2"
                                                                         stroke-linecap="round" stroke-linejoin="round"
                                                                         class="icon svg-icon-ti-ti-minus page_speed_1627634574">
                                                                         <path stroke="none" d="M0 0h24v24H0z"
                                                                             fill="none" />
                                                                         <path d="M5 12l14 0" />
                                                                     </svg></button>
                                         ...
                                         <div class="bb-product-filter">
                                             ...
                                             <div class="bb-product-filter-content">
                                                 <div class="bb-product-price-filter">
                                                     <div class="price-slider mb-20" data-min="0" data-max="56800944">
                                                     </div>
                                                     <div
                         ...
                         <div class="tp-shop-main-wrapper">
                             ...
                             <div class="bb-product-items-wrapper tp-shop-item-primary">
                                 ...
                                 <nav class="tp-pagination">
                                     <ul class="pagination">
                                         <li class="page-item">
                                             <a class="pages-number" href="products2679.html?page=1" rel="prev"
                                                 aria-label="&laquo; Previous"><svg width=15 height=13
                                         ...
                                         <li class="page-item">
                                             <a class="pages-number" href="products2679.html?page=1">1</a>
                                         </li>
                                         <li class="page-item active" aria-current="page">
                                             <span class="current pages-number">2</span>
                                         </li>
                                         <li class="page-item">
                                             <a class="pages-number" href="products9ba9.html?page=3">3</a>
                                         </li>
                                         <li class="page-item">
                                             <a class="pages-number" href="products9ba9.html?page=3" rel="next"
