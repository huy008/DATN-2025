 <header>
                             ...
                             <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                                 <div class="tp-header-login d-flex align-items-center ml-50">
                                          <div class="tp-header-login-icon">
                                             <span class="page_speed_1653511719"><svg width=17 height=21
    ...
    <a href="{{ route('orders.index') }}" class="tp-header-action-btn" title="Đơn hàng của bạn">
        <svg width="22" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3 3H5H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M8 3L9.39559 5.78994C9.775 6.5416 10.5754 7 11.4481 7H20.5C21.3284 7 22 7.67157 22 8.5V17.5C22 18.3284 21.3284 19 20.5 19H6C5.17157 19 4.5 18.3284 4.5 17.5V6.5C4.5 5.67157 5.17157 5 6 5H7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <span class="tp-header-action-badge" data-bb-value="order-count">
            {{ Auth::check() ? Auth::user()->orders()->count() : 0 }}
                                     ...
                                     <div class="tp-header-action-item">
                                         <a href="{{route('cart.index')}}" class="tp-header-action-btn cartmini-open-btn"
                             ...
                             <div class="col-xl-6 col-lg-6">
                                 <div class="main-menu menu-style-1">
                                     <nav class="tp-main-menu-content">
                                         <ul>
                                                {{-- @foreach (session('categories') as $item)
