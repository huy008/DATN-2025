                             ...
                             <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                                 <div class="tp-header-login d-flex align-items-center ml-50">
                                     <div class="tp-header-login-icon">
                                         @if (Auth::check() && Auth::user()->img_thumbnail)
                                             <img src="{{ asset(Auth::user()->img_thumbnail) }}" alt="Profile"
                                                 width="40" height="40"
                                     ...
                                     <div class="tp-header-login-content d-none d-xl-block">
                                         @auth
                                             <a href="{{ route('profile.index') }}" class="page_speed_1653511719">
                                         ...
                                         <a href="{{ route('cart.index') }}"
                                             ...
                                             data-url="https://shofy.botble.com/ajax/cart-content"><svg width=21
                                                 ...
                                                 <path d="M13.5343 10.1018H13.5801" stroke="currentColor"
                                                     stroke-width="1.5" stroke-linecap="round"
                                                     stroke-linejoin="round" />
                                             </svg><span class="tp-header-action-badge" data-bb-value="cart-count">
                                                 @if (Auth::check())
        ...
        <a class="bb-quick-search-item" href="${product.url}">
            ...
            <div class="bb-quick-search-item-info">
                ...
                <div class="bb-quick-search-item-price">
                    <span class="new-price">${product.final_price ? product.final_price : ''} </span>
